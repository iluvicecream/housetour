...
dawnMoodMsg = [
  ...
  "the birds aren't even awake yet bro what are you doing :O",
];

morningMoodMsg = [
  "morninggg! pls tell me you had some coffee/tea",
...
nightMoodMsg = [
  "mmhm, the night is young and so are you! (jk go to bed)",
  "just go to bed already, the web will still be here tomorrow",
  "why are you here at this time, am trying to sleep",
  "no get out of my web, come back tomorrow, go to bed",
  "you should be sleeping right now, not browsing the web",
  "why are you still here, go to bed, the web will still be here tmr",
  "the server need rest too, go to bed, the web will still be here tomorrow",
  "my server call me and say you should go to bed, the web will still be here tmr"
];

lateMoodMsg = [
  "sleep pls it too late man",
  "why the f*uk are you browsing the web at this time, go to bed",
  "gurl what the f*uk are you doing here rn",
  "damm trying to full an all nigher huh"
];
...
switch (currHour) {
    ...
    case 4:
    case 5:
        moodGifEmbed.src = dawnMoodGif[Math.floor(Math.random() * dawnMoodGif.length)];
        break;
    case 6:
    case 7:
    case 8:
    ...
    case 10:
    case 11:
        moodGifEmbed.src = morningMoodGif[Math.floor(Math.random() * morningMoodGif.length)];
        break;
    case 12:
        moodGifEmbed.src = lunchMoodGif[Math.floor(Math.random() * lunchMoodGif.length)];
        break;
    case 13:
    case 14:
    case 15:
    case 16:
    case 17:
        moodGifEmbed.src = afternoonMoodGif[Math.floor(Math.random() * afternoonMoodGif.length)];
        break;
    case 18:
        moodGifEmbed.src = dinnerMoodGif[Math.floor(Math.random() * dinnerMoodGif.length)];
        break;
    case 19:
    case 20:
    case 21:
    case 22:
        moodGifEmbed.src = nightMoodGif[Math.floor(Math.random() * nightMoodGif.length)];
        break;
    case 23:
    case 0:
    case 1:
    case 2:
        moodGifEmbed.src = lateMoodGif[Math.floor(Math.random() * lateMoodGif.length)];
        break;
}